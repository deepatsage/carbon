...
<Preview>
  <Story name="basic">
    <DraggableContainer>
      <DraggableItem key="1" id={1}>Some content goes 1</DraggableItem>
      <DraggableItem key="2" id={2}>Some content goes 2</DraggableItem>
      <DraggableItem key="3" id={3}>Some content goes 3</DraggableItem>
      <DraggableItem key="4" id={4}>Some content goes 4</DraggableItem>
    </DraggableContainer>
  </Story>
</Preview>
