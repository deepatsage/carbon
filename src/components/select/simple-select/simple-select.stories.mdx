...
The `isLoading` prop in combination with the `onListScrollBottom` prop could be used to implement infinite scroll.
That prop will be called evertytime user scrolls to the bottom of the list.
