...
<Preview style={{backgroundColor: '#e6ebed'}}>
  <Story name="default with colour background" parameters={{ info: { disable: true }, chromatic: { disable: true }}} >
    <Search placeholder="Search..." defaultValue=""/>
  </Story>
</Preview>
...
<Preview style={{ backgroundColor: "#003349"}}>
  <Story name="with Alt Styling and no button" parameters={{ info: { disable: true }}}>
    <Search 
      placeholder="Search..." 
      defaultValue="" 
      variant="dark"
